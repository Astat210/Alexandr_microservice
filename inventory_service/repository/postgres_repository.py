...
class PostgresRepository:
    ...
    def create_purchase(self, customer_id: int, purchase_date: str, total_amount: float):
        try:
            ...
            logging.info(f"Created purchase for customer: {self.customer_id}")
            return purchase
        except SQLAlchemyError as e:
    ...
    def get_stock_report(self, start_date: str = None, end_date: str = None, category_id: int = None, page: int = 1,
        ...
        try:
            ...
            .join(PurchaseItem, Product.product_id == PurchaseItem.product_id)
            .join(Purchase, PurchaseItem.purchase_id == Purchase.purchase_id)
        if start_date:
